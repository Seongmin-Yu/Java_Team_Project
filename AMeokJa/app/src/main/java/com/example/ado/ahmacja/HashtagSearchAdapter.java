...
public class HashtagSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    HashtagSearchAdapter(ArrayList<HashtagInfo> HashtagInfoArrayList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_hashtag_search, parent, false);
